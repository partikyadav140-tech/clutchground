  ...
  return (
    <Link to="/" className="flex items-center gap-3 group">
      <img
        ...
        className="object-contain drop-shadow-[0_0_12px_oklch(0.72_0.22_40/0.6)] group-hover:drop-shadow-[0_0_20px_oklch(0.72_0.22_40/0.9)] transition-all duration-300 animate-flicker"
      />
      {withText && (
