      ...
      <div className="container mx-auto px-4 lg:px-8 pt-12">
        <div className="flex flex-col items-center justify-center gap-6 text-center">
          ...
          <div className="flex flex-col gap-1.5 items-center">
            <p className="text-sm font-display font-bold tracking-widest text-muted-foreground uppercase">
              © 2026 CLUTCHGROUND
            </p>
            <p className="text-xs text-muted-foreground/80 tracking-wide">
              Designed & Developed by Pratikk Yadav <span className="mx-1 text-primary">|</span> +91
              8307224756
            </p>
          </div>
        </div>
