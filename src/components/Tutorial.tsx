      ...
      const timer = setTimeout(() => {
        ...
        const steps = [
          ...
          { 
            ...
            popover: { 
              title: '🏆 Tournaments', 
              description: 'This is where the action happens. Browse active tournaments and join solo or squad battles for real cash prizes!', 
          ...
          { 
            ...
            popover: { 
              ...
              description: 'Create your own squad or join an existing team. You need a verified team to enter squad tournaments.', 
              side: isMobile ? "over" : "bottom", 
              align: isMobile ? "center" : "start" 
            } 
          },
