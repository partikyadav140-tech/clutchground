...
export const DP_ANIMATIONS: DpAnimationDef[] = [
  {
    ...
    value: "none",
    label: "None",
    description: "No avatar animation border",
    cost: 0,
    color: "#64748b",
    emoji: "👤",
    tier: "free",
  ...
  },
  {
    ...
    value: "pulse",
    label: "Heartbeat",
    description: "Soft heartbeat pulse ripple around the avatar",
    cost: 50,
    color: "#94a3b8",
    emoji: "💓",
    tier: "common",
  ...
  },
  {
    ...
    value: "glow",
    label: "Solar Flare",
    description: "Vibrant solar orange glow with breathing effect",
    cost: 120,
    color: "#f97316",
    emoji: "🔥",
    tier: "rare",
  ...
  },
  {
    ...
    value: "fire",
    label: "Inferno",
    description: "Flames erupting from the avatar with floating embers",
    cost: 200,
    color: "#ef4444",
    emoji: "🌋",
    tier: "epic",
  ...
  },
  {
    ...
    value: "neon",
    label: "Cyber Surge",
    description: "Spinning colorful neon RGB gradient ring border",
    cost: 350,
    color: "#a78bfa",
    emoji: "🌈",
    tier: "legendary",
...
export const BANNER_PRESETS: BannerPresetDef[] = [
  {
    ...
    value: "default",
    label: "Default Space",
    description: "Standard deep space gradient background",
    cost: 0,
    color: "#64748b",
    emoji: "🌌",
    tier: "free",
  ...
  },
  {
    id: "banner-blaze",
    value: "blaze",
    label: "Infernal Blaze",
    description: "Fiery orange-red static gradient background",
    cost: 80,
    color: "#f97316",
    emoji: "🔥",
    tier: "rare",
  ...
  },
  {
    ...
    value: "void",
    label: "Deep Void",
    description: "Dark cosmic violet static gradient background",
    cost: 80,
    color: "#7c3aed",
    emoji: "👾",
    tier: "rare",
  ...
  },
  {
    ...
    value: "royal",
    label: "Royal Purple",
    description: "Sunset golden-purple luxury static gradient",
    cost: 120,
    color: "#fbbf24",
    emoji: "👑",
    tier: "epic",
  ...
  // Animated banners
  {
    id: "banner-cyber-anim",
    value: "cyber_anim",
    label: "Cyber Wave (Animated)",
    description: "Looping cyan-magenta holographic wave background",
    cost: 250,
    color: "#06b6d4",
    emoji: "⚡",
    tier: "epic",
  ...
  },
  {
    id: "banner-fire-anim",
    value: "fire_anim",
    label: "Solar Wind (Animated)",
    description: "Dynamic moving cosmic flame solar background",
    cost: 350,
    color: "#ef4444",
    emoji: "☄️",
    tier: "legendary",
...
export const PROFILE_EFFECTS: ProfileEffectDef[] = [
  {
    ...
    value: "none",
    label: "None",
    description: "No profile card effects",
    cost: 0,
    color: "#64748b",
    emoji: "❌",
    tier: "free",
  ...
  },
  {
    ...
    description: "Twinkling golden sparkles falling down the profile",
    cost: 100,
    color: "#fbbf24",
    emoji: "✨",
    tier: "rare",
  ...
  },
  {
    ...
    value: "hearts",
    label: "Lovestruck",
    description: "Floating neon pink hearts drifting upwards",
    cost: 150,
    color: "#ec4899",
    emoji: "💖",
    tier: "rare",
  ...
  },
  {
    ...
    description: "Intermittent purple lightning sparks across the card",
    cost: 250,
    color: "#a78bfa",
    emoji: "⚡",
    tier: "epic",
  ...
  },
  {
    ...
    value: "flames",
    label: "Phoenix Aura",
    description: "Rising animated flames at the bottom of the profile",
    cost: 400,
    color: "#ef4444",
    emoji: "🔥",
    tier: "legendary",
...
export function computeAchievements(stats: {
  ...
  if ((stats.firstPlaces || 0) >= 1)
    unlocked.push(ACHIEVEMENT_DEFS.find((a) => a.id === "first_win")!);
  if ((stats.matchesPlayed || 0) >= 10)
    unlocked.push(ACHIEVEMENT_DEFS.find((a) => a.id === "veteran")!);
  if ((stats.totalKills || 0) >= 50)
    unlocked.push(ACHIEVEMENT_DEFS.find((a) => a.id === "slayer")!);
  if ((stats.firstPlaces || 0) >= 5)
    unlocked.push(ACHIEVEMENT_DEFS.find((a) => a.id === "champion")!);
  if ((stats.totalEarnings || 0) >= 1000)
    unlocked.push(ACHIEVEMENT_DEFS.find((a) => a.id === "high_roller")!);
