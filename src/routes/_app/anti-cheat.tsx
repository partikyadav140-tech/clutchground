    ...
    <div className="bg-background min-h-screen pb-24">
      ...
      <div className="px-4 mt-6">
        <p className="text-sm font-semibold text-muted-foreground text-center mb-8 px-4">
          Our anti-cheat system combines screenshot validation, peer reports, and admin review to keep the arena clean.
        </p>

        <div className="grid sm:grid-cols-2 gap-4">
          {[
            { icon: CheckCircle2, t: "Screenshot Validation", d: "Every result requires screenshot proof of kills and final placement.", color: "text-green-500", bg: "bg-green-50" },
            { icon: Eye, t: "Admin Review", d: "Trained moderators verify every match within 24 hours of submission.", color: "text-blue-500", bg: "bg-blue-50" },
            { icon: AlertCircle, t: "Report System", d: "Players can flag cheaters in-app. 3+ reports trigger instant review.", color: "text-amber-500", bg: "bg-amber-50" },
            { icon: Shield, t: "Permanent Bans", d: "Confirmed cheaters and their teams are banned permanently. No exceptions.", color: "text-red-500", bg: "bg-red-50" },
          ].map((f, i) => (
            <motion.div 
            ...
            >
              <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-4 ${f.bg} ${f.color}`}>
