...
function ForgotPasswordPage() {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await (verifyEmailOtp as any)({ data: { otpId, otp: code, purpose: "forgot_password" } });
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-background overflow-hidden relative">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground font-medium text-center">{stepSubs[step - 1]}</p>
        ...
        <AnimatePresence mode="wait" custom={dir}>
          ...
          {step === 1 && (
            <motion.form key="fp-step1" custom={dir} variants={SLIDE} initial="initial" animate="animate" exit="exit"
              ...
              <div className="mt-2">
                <Link to="/login">
                  <button type="button" className="w-full h-12 rounded-2xl font-black text-sm border border-border text-muted-foreground flex items-center justify-center gap-2 press-effect active:scale-95">
          ...
          {/* ── Step 2: OTP ── */}
          {step === 2 && (
            <motion.form key="fp-step2" custom={dir} variants={SLIDE} initial="initial" animate="animate" exit="exit"
          ...
          {/* ── Step 3: New Password ── */}
          {step === 3 && (
            <motion.form key="fp-step3" custom={dir} variants={SLIDE} initial="initial" animate="animate" exit="exit"
