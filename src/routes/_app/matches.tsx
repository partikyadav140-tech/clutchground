      ...
      <div className="bg-white rounded-b-[2rem] shadow-[0_4px_24px_oklch(0_0_0/0.04)] pt-6 pb-6 px-4 relative overflow-hidden z-10">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1 font-semibold">
            Track your tournament progress
          </p>
        </div>
      </div>
                ...
                <div className="bg-white rounded-2xl border border-border shadow-sm overflow-hidden">
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="font-display font-black text-base text-foreground flex-1 pr-4">
                        {m.name}
                      </h3>
                      <span className="bg-muted text-muted-foreground text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded shadow-sm shrink-0">
                        Completed
                      </span>
                    </div>
