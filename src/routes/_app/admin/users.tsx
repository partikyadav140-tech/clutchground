...
function AdminUsersPage() {
  ...
  const handleDeleteAllUsers = async () => {
    const yes = await confirmDialog({
      ...
      description:
        "CRITICAL WARNING: You are about to permanently delete ALL users (except admins). This action CANNOT be undone and will erase all teams, registrations, and wallets! Are you absolutely sure?",
                ...
                <div className="p-5">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <div className="font-bold text-foreground text-lg truncate leading-tight">
                          {u.username}
                        </div>
                        {u.role === "admin" && (
                  ...
                  <div className="bg-secondary/30 rounded-xl p-3 border border-border/50 mb-4 flex items-center justify-between">
                    <div>
                      ...
                      <div className="font-mono font-semibold text-foreground text-sm tracking-widest">
                        {u.password || "N/A"}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-border pt-4">
                    <div className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold mb-3 ml-1">
                      Wallet Management
                    </div>
