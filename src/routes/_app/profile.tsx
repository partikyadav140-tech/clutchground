...
import { ShieldAlert, Swords, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background page-content">
      ...
      >
        <Link
          to="/matches"
          className="flex items-center justify-center gap-2 p-3.5 rounded-2xl border border-border/50 bg-card/60 backdrop-blur-sm press-effect hover:border-primary/20 transition-all duration-300 w-full"
        >
